...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount {
    if (self = [super initWithMaxImagesCount:maxImagesCount delegate:nil]) {
        ...
        self.naviBgColor = [UIColor colorWithPatternImage:[PostboxReducerFont getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:PostboxReducerFontDirectionLevel]];
