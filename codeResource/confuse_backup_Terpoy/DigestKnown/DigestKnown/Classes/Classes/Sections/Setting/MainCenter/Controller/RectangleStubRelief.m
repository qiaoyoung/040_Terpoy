...
//    [ScaffoldOntoOrchestrate show];
    ...
    [LocalizeElevateModest uploadImagesWithURL:Server_other_feedback parameters:dict images:array imageNames:nameArray progress:^(NSProgress *progress) {
...
//        [ScaffoldOntoOrchestrate dismiss];
        [self.loadingView animationClose];
        [ScaffoldOntoOrchestrate showMessage:LangKey(@"group_info_activity_op_failed")];
    }];
...
- (UIImagePickerController *)imagePickerVc {
    if (_imagePickerVc == nil) {
        ...
        _imagePickerVc.navigationBar.barTintColor = [UIColor colorWithPatternImage:[PostboxReducerFont getLinearGradientImage:RGB_COLOR_String(kCommonBGColor_begin) and:RGB_COLOR_String(kCommonBGColor_end) directionType:PostboxReducerFontDirectionLevel]];
