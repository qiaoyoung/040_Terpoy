...
#import "AtTryQuill.h"
@interface LabelCrestlineProcessPrime ()
...
@implementation LabelCrestlineProcessPrime
...
-(void)commitButtonClick
{
    ...
    [LocalizeElevateModest getWithUrl:Server_user_modifyPass params:dict isShow:YES success:^(id responseObject) {
