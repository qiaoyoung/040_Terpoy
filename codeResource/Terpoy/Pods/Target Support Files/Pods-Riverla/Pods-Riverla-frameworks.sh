...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DigestKnown/NIMSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DigestKnown/NIMNOS.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DigestKnown/NIMQuic.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DigestKnown/NIMSocketRocket.framework"
fi
