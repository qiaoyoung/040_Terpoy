...
- (UITableViewCell*)builidBlueButtonCell:(id<RadiantPositionedSummit>) bodyData{
    ChipTextWave * cell = [self.tableView dequeueReusableCellWithIdentifier:TableButtonCellReuseId];
    if (!cell) {
        cell = [[ChipTextWave alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:TableButtonCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
...
- (UITableViewCell*)builidTeamMemberCell:(id<RadiantPositionedSummit>) bodyData{
    OfFacadePin * cell = [self.tableView dequeueReusableCellWithIdentifier:TableMemberCellReuseId];
    if (!cell) {
        cell = [[OfFacadePin alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:TableMemberCellReuseId];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
