...
{
    UnloadTerrainClipperCoderExtend *emoticonCatalog = [[ContextRemediationLocalTime sharedManager] emoticonCatalog:NEEKIT_EmojiCatalog];
    if (emoticonCatalog) {
...
{
    UnloadTerrainClipperCoderExtend *emoticonCatalog = [[ContextRemediationLocalTime sharedManager] emoticonCatalog:NEEKIT_EmojiGifCatalog];
    if (emoticonCatalog) {
        EntityWrapper *layout = [[EntityWrapper alloc] initEmojiLayout:self.device_width];
        emoticonCatalog.layout = layout;
        emoticonCatalog.pagesCount = [self numberOfPagesWithEmoticon:emoticonCatalog];
