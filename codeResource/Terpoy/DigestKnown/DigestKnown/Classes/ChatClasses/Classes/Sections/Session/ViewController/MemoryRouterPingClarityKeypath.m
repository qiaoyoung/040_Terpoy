...
{
    if(!_customAlbumView){
        _customAlbumView = [[AngularSteamDirect alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
...
{
    if(!_audioContent){
        _audioContent = [[TraceParameterTransform alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
