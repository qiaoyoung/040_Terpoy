...
//: @implementation NSString (PerformAcknowledgePoolState)
@implementation NSString (PerformAcknowledgePoolState)
...
- (NSString *)theoryOrDiamond:(NSString *)table {
    //: NSBundle * languageBundle = [PerformAcknowledgePoolState sharedKit].languageBundle;
    NSBundle * languageBundle = [PerformAcknowledgePoolState rock].creative;
    //: return [self nim_localizedByBundle:languageBundle table:table];
    return [self scene:languageBundle fair:table];
}

//: - (NSString *)nim_localizedByBundle:(NSBundle *)bundle table:(NSString *)table {
- (NSString *)scene:(NSBundle *)bundle fair:(NSString *)table {
    //: if (!bundle) {
    if (!bundle) {
        //: return self;
        return self;
...
- (NSString *)root {
    //: NSString * result = [self nim_localizedWithTable:[PerformAcknowledgePoolState sharedKit].languageTable];
    NSString * result = [self theoryOrDiamond:[PerformAcknowledgePoolState rock].text];
    //: return result;
    return result;
}
