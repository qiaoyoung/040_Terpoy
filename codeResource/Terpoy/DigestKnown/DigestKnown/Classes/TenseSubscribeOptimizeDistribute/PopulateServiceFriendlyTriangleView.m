...
// __CLOSE_PRINT__
//
//  PopulateServiceFriendlyTriangleView.m
...
//: @interface PopulateServiceFriendlyTriangleView ()
@interface PopulateServiceFriendlyTriangleView ()

//: @end
@end

//: @implementation PopulateServiceFriendlyTriangleView
@implementation PopulateServiceFriendlyTriangleView

//: - (void)setTriangleColor:(UIColor *)triangleColor {
- (void)setTransit:(UIColor *)triangleColor {
    //: _triangleColor = triangleColor;
    _transit = triangleColor;
