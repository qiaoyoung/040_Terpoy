...
// __CLOSE_PRINT__
//
//  UIView+DuplicateInsideBufferRenderer.m
//  SDRefreshView
//
...
//: @implementation UIView (DuplicateInsideBufferRenderer)
@implementation UIView (DuplicateInsideBufferRenderer)
...
- (void)setProjection:(CGFloat)sd_height
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
...
- (void)setTheoryFound:(CGFloat)sd_width
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
...
- (void)setBringExtent:(CGFloat)sd_x
{
    //: CGRect temp = self.frame;
    CGRect temp = self.frame;
    //: temp.origin.x = sd_x;
