...
#define kRoyalPresenterHarmonicManagerVersionKey @"kRoyalPresenterHarmonicManagerVersionKey"
...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kDigestKnown];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kDigestKnown];
    ...
    NSString *path = [[PerformAcknowledgePoolState sharedKit].emoticonBundle pathForResource:kDigestKnown ofType:@".zip"];
    if (!path) {
