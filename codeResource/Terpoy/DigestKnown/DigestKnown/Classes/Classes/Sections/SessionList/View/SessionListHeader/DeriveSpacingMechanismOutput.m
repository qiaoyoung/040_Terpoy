...
- (UIColor *)fillBackgroundColor:(DeriveSpacingMechanismOutputType)type{
    NSDictionary *dict = @{
                           @(DeriveSpacingMechanismOutputTypeNetStauts)    : UIColorFromRGB(0xFFE3E3),
                           @(DeriveSpacingMechanismOutputTypeCommonText)   : UIColorFromRGB(0xff6347),
                           @(DeriveSpacingMechanismOutputTypeLoginClients) : UIColorFromRGB(0xff6347)
                           };
    return dict[@(type)];
}
