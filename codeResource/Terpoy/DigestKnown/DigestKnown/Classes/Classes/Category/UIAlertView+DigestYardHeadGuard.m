...
// __CLOSE_PRINT__
//
//  UIAlertView+DigestYardHeadGuard.m
//  eim_iphone
//
...
static char commonSegmentString;

//: @implementation UIAlertView (DigestYardHeadGuard)
@implementation UIAlertView (DigestYardHeadGuard)
...
- (void)everyAssist
{
    ...
    objc_setAssociatedObject(self, &commonSegmentString, nil, OBJC_ASSOCIATION_COPY);
}


//: - (void)alertView:(UIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex
- (void)addressClick:(UIAlertView *)alertView style:(NSInteger)buttonIndex
{
    //: AlertBlock block = objc_getAssociatedObject(self, &kUIAlertViewBlockAddress);
    AlertBlock block = objc_getAssociatedObject(self, &commonSegmentString);
    //: if (block)
    if (block)
    {
        //: block(buttonIndex);
...
- (void)sub: (void (^)(NSInteger))block
{
    //: self.delegate = self;
    self.delegate = self;
    //: objc_setAssociatedObject(self,&kUIAlertViewBlockAddress,block,OBJC_ASSOCIATION_COPY);
    objc_setAssociatedObject(self,&commonSegmentString,block,OBJC_ASSOCIATION_COPY);
    //: [self show];
    [self show];
}
...
//: @implementation UIAlertController (DigestYardHeadGuard)
@implementation UIAlertController (DigestYardHeadGuard)
