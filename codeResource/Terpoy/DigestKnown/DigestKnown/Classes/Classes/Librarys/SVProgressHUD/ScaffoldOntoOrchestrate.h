...
@property (assign, nonatomic) ScaffoldOntoOrchestrateStyle defaultStyle UI_APPEARANCE_SELECTOR;

/// Represents the type of mask applied when the HUD is displayed.
/// @discussion Default: ScaffoldOntoOrchestrateMaskTypeNone.
@property (assign, nonatomic) ScaffoldOntoOrchestrateMaskType defaultMaskType UI_APPEARANCE_SELECTOR;

/// Defines the animation type used when the HUD is displayed.
/// @discussion Default: ScaffoldOntoOrchestrateAnimationTypeFlat.
@property (assign, nonatomic) ScaffoldOntoOrchestrateAnimationType defaultAnimationType UI_APPEARANCE_SELECTOR;
