...
extern __attribute__((visibility ("default"))) NSString *const commonTwistString(NSString *value);/** Touken前缀*/

extern __attribute__((visibility ("default"))) NSString *const widgetActionStatusHelper(NSString *value);/** 加密密钥*/

extern __attribute__((visibility ("default"))) NSString *const commonEasyError(NSString *value);/** 即时聊天*/
