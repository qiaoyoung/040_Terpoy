...
NS_ASSUME_NONNULL_BEGIN
	...
	#define ValidateSlashResponsive_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define ValidateSlashResponsive_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef ValidateSlashResponsive_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, ValidateSlashResponsiveQuerySynchronizationMode) {
...
#ifdef ValidateSlashResponsive_ACCESS_GROUP_AVAILABLE
