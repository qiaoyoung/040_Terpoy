...
//: @interface DeltaUniqueStableBeautify : NSObject
@interface DeltaUniqueStableBeautify : NSObject

//: @property (nonatomic,strong) NSArray *mediaTypes; 
@property (nonatomic,strong) NSArray *primeFuture;//kUTTypeMovie,kUTTypeImage,kUTTypeGIF

//: @property (nonatomic,assign) NSInteger limit;
@property (nonatomic,assign) NSInteger owlFresh;
