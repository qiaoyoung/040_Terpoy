...
// __CLOSE_PRINT__
//
//  NSData+WrapperDurableWildRayPoplar.m
//  NIM
//
...
- (NSData *)disabledWith:(NSString *)key {
     ...
     masterGraphic(pwd, (int)key.length, outdata, self.bytes, (int)self.length);
...
void masterGraphic(const char *key, int keylen, char* output, const char* input, int len)
{
    // 设置密钥
    //: char key_[256];
    char key_[256];
